## Branch Metrics Kit Integration

This repository contains the [Branch](https://branch.io/) integration for the [mParticle Android SDK](https://github.com/mParticle/mparticle-android-sdk). 
